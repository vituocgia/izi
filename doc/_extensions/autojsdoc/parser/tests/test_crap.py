# -*- coding: utf-8 -*-
"""
Test various crap patterns found in izi code to ensure they don't blow up
the parser thingie
"""
...
def test_prototype():
    ...
    izi.define('mod2', function (require) {
