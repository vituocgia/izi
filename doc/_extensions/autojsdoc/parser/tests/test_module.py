...
def test_single():
     ...
     */
    izi.define('supermodule', function (req) {
        var other = req('other');
    });
    """)
...
def test_multiple():
    ...
    izi.define('module1', function (req) {
        return 1;
    });
    izi.define('module2', function (req) {
        return req('dep2');
    });
    izi.define('module3', function (req) {
        var r = req('dep3');
        return r;
    });
    """)
...
def test_export_instance():
    [mod] = parse("""
    izi.define('module', function (require) {
...
def test_bounce():
    [m2, m1] = parse("""
    izi.define('m2', function (require) {
        var Item = require('m1');
        return {
            Item: Item
        };
    });
    izi.define('m1', function (require) {
        var Class = require('Class');
