...
izi is greatly data-driven, and a big part of modules definition is thus
...
The main way to define data in izi is via XML data files: The broad structure
of an XML data file is the following:

* Any number of operation elements within the root element ``izi``
...
``search``
    ...
    the field is a :class:`~izi.fields.Many2one`
``ref``
    ...
    Mostly for :class:`~izi.fields.Many2one` and
    :class:`~izi.fields.Reference` fields
``type``
...
Because some important structural models of izi are complex and involved,
...
.. literalinclude:: ../../izi/addons/base/res/res.country.state.csv
    :language: text
    :lines: 1-15
...
.. csv-table::
    :file: ../../izi/addons/base/res/res.country.state.csv
    :header-rows: 1
