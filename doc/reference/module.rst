...
The manifest file serves to declare a python package as an izi module
...
``category`` (``str``, default: ``Uncategorized``)
    classification category within izi, rough business domain for the module.
...
``depends`` (``list(str)``)
    izi modules which must be loaded before this one, either because this
...
.. _existing categories:
     https://github.com/izi/izi/blob/master/izi/addons/base/module/module_data.xml
