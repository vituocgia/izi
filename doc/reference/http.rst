...
The request object is automatically set on :data:`izi.http.request` at
the start of the request

.. autoclass:: izi.http.WebRequest
    :members:
    :member-order: bysource
.. autoclass:: izi.http.HttpRequest
    :members:
.. autoclass:: izi.http.JsonRequest
    :members:

Response
========

.. autoclass:: izi.http.Response
    :members:
    :member-order: bysource
...
:class:`~izi.models.Model`, but can't use the same mechanism as the
...
.. autoclass:: izi.http.Controller

and defining methods decorated with :func:`~izi.http.route`::

    class MyController(izi.http.Controller):
...
* decorating with :func:`~izi.http.route` is necessary to keep the method
