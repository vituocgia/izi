...
Aside from manually managing access using custom code, izi provides two main
...
An ORM :class:`~izi.fields.Field` can have a ``groups`` attribute
...
* restricted fields are removed from :meth:`~izi.models.Model.fields_get`
  responses
