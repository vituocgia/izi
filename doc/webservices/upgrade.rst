...
This document describes the API used to upgrade an izi database to a
higher version.

It allows a database to be upgraded without ressorting to the html form at
https://upgrade.izi.asia
...
* your email address
* the target version (the izi version you want to upgrade to)
* the purpose of your request (test or production)
* the database dump name (required but purely informative)
* optionally the server timezone (for izi source version < 6.1)

The ``create`` method
---------------------

.. py:function:: https://upgrade.izi.asia/database/v1/create
    ...
    :param str target: (required) the izi version you want to upgrade to. Valid choices: 6.0, 6.1, 7.0, 8.0
    ...
    :param str timezone: (optional) the timezone used by your server. Only for izi source version < 6.1
...
.. switcher::
    ...
    .. code-block:: python
        ...
        CREATE_URL = "https://upgrade.izi.asia/database/v1/create"
...
.. py:function:: https://upgrade.izi.asia/database/v1/upload
...
.. switcher::
    ...
    .. code-block:: python
        ...
        UPLOAD_URL = "https://upgrade.izi.asia/database/v1/upload"
...
.. py:function:: https://upgrade.izi.asia/database/v1/request_sftp_access
...
.. switcher::
    ...
    .. code-block:: python
        ...
        UPLOAD_URL = "https://upgrade.izi.asia/database/v1/request_sftp_access"
    ...
    .. code-block:: bash
        ...
        REQUEST_SFTP_ACCESS_URL="https://upgrade.izi.asia/database/v1/request_sftp_access"
        SSH_KEYS=/path/to/your/authorized_keys
        KEY="Aw7pItGVKFuZ_FOR3U8VFQ=="
        REQUEST_ID="10534"
        URL_PARAMS="key=${KEY}&request=${REQUEST_ID}"
...
::
    ...
    $ sftp -P 2200 user_10534@upgrade.izi.asia
    Connected to upgrade.izi.asia.
...
::
  ...
  echo "put /path/to/openchs.70.cdump openchs.70.cdump" | sftp -b - -P 2200 user_10534@upgrade.izi.asia
...
.. py:function:: https://upgrade.izi.asia/database/v1/process
...
.. switcher::
    ...
    .. code-block:: python
        ...
        PROCESS_URL = "https://upgrade.izi.asia/database/v1/process"
...
.. py:function:: https://upgrade.izi.asia/database/v1/status
...
.. switcher::
    ...
    .. code-block:: python
        ...
        STATUS_URL = "https://upgrade.izi.asia/database/v1/status"
...
``target``
    the target izi version you supplied when creating the request
``aim``
...
``issue_stage``
    the stage of the issue we have create on izi main server
``issue``
    the id of the issue we have create on izi main server
``status_url``
...
``database_version``
    the guessed izi version of your uploaded (not upgraded) database
``postgresql``
    ...
    .. code-block:: json

        {
          ...
          "request": {
            ...
            "issue_stage": "new",
            "issue": 648398,
            "status_url": "https://upgrade.izi.asia/database/eu1/10534/Aw7pItGVKFuZ_FOR3U8VFQ==/status",
            "notes_url": "https://upgrade.izi.asia/database/eu1/10534/Aw7pItGVKFuZ_FOR3U8VFQ==/upgraded/notes",
            "original_sql_url": "https://upgrade.izi.asia/database/eu1/10534/Aw7pItGVKFuZ_FOR3U8VFQ==/original/sql",
            "original_dump_url": "https://upgrade.izi.asia/database/eu1/10534/Aw7pItGVKFuZ_FOR3U8VFQ==/original/archive",
            "upgraded_sql_url": "https://upgrade.izi.asia/database/eu1/10534/Aw7pItGVKFuZ_FOR3U8VFQ==/upgraded/sql",
            "upgraded_dump_url": "https://upgrade.izi.asia/database/eu1/10534/Aw7pItGVKFuZ_FOR3U8VFQ==/upgraded/archive",
            "modules_url": "https://upgrade.izi.asia/database/eu1/10534/Aw7pItGVKFuZ_FOR3U8VFQ==/modules/archive",
            "filesize": "912.99 Kb",
            "database_uuid": null,
