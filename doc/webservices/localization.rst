...
.. warning::
    ...
    This tutorial requires knowledges about how to build a module in izi (see
    :doc:`../../howtos/backend`).
...
Although some additional types could be created in a localization module, we encourage the usage of the existing types in the `account/data/data_account_type.xml <https://github.com/izi/izi/blob/11.0/addons/account/data/data_account_type.xml>`_ file.
...
.. note::
    If you need more information about what is a fiscal position and how it works in izi, please refer to `How to adapt taxes to my customer status or localization <https://www.izi.asia/documentation/user/online/accounting/others/taxes/application.html>`_.
...
.. note::
    How a bank operation model works exactly in izi? See `Configure model of entries <https://www.izi.asia/documentation/user/online/accounting/bank/reconciliation/configure.html>`_.
...
Once it's done, you can start the creation of your report statements. The documentation is available in the following `slides <https://www.izi.asia/slides/slide/how-to-create-custom-accounting-report-415>`_.
