...
In order for your contribution to izi to be accepted, you have to sign the
izi Contributor License Agreement (CLA). More information about this
...
2.  Modify your current pull request, or make a new pull request on
    [izi/izi](/izi/izi), adding a new file `<github-login>.md` under the
...
3. An izi R&D Team member will verify and accept your Pull Request. You can
...
2.  Modify your current pull request, or make a new pull request on
    [izi/izi](/izi/izi), adding a new file `<lowercase-company-name>.md`
    under the [`doc/cla/corporate`](corporate/) directory.
    If the name of the company is izi, the file would be
    `doc/cla/corporate/izi.md`. The file should contain:

```
<country>, <date>

<company-name> agrees to the terms of the izi Corporate Contributor License
Agreement v1.0.
...
`cla-submission` `at` `izi.asia`.  In that case someone from the izi team will
make the pull request on your behalf.

* Printable izi CCLA v1.0 https://www.izi.asia/files/legal/izi-CCLA-v1.0.pdf
* Printable izi ICLA v1.0 https://www.izi.asia/files/legal/izi-ICLA-v1.0.pdf

# FAQ

## Why do I need to accept a CLA ?

The goal of having a Contributor License Agreement for izi is to:

* clearly define the terms under which intellectual property (patches, pull
  requests, etc.) have been contributed to the izi project

* protect the izi project and its users in case of legal dispute about the
  origin or ownership of any part of the code

* protect the izi project and its users from bad actors who would contribute
...
contributor really intended to contribute to the izi project under specific
...
The izi CLA is based on the Apache Software Foundation CLA v2.0, as
...
irrevocable license to the project maintainer, izi S.A. to use, modify and
...
(ICLA) of izi.  The agreement is executed by adding your name and
