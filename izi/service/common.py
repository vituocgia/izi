...
RPC_VERSION_1 = {
        'server_version': izi.release.version,
        'server_version_info': izi.release.version_info,
        'server_serie': izi.release.serie,
        'protocol_version': 1,
}
...
def exp_about(extended=False):
    ...
    if extended:
        return info, izi.release.version
    return info

def exp_set_loglevel(loglevel, logger=None):
    # TODO Previously, the level was set on the now deprecated
    # `izi.netsvc.Logger` class.
    return True
