...
from izi.tools import frozendict, classproperty
...
def constrains(*args):
    ...
    Should raise :class:`~izi.exceptions.ValidationError` if the
    validation failed.
...
def one(method):
    """ Decorate a record-style method where ``self`` is expected to be a
        ...
        .. deprecated:: 9.0
            ...
            is a single record with :meth:`~izi.models.Model.ensure_one`.
    """
...
from izi.exceptions import UserError, AccessError, MissingError
