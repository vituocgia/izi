...
from izi import api, models, registry, SUPERUSER_ID, _
from izi.exceptions import AccessError, RedirectWarning, UserError
...
class ResConfigSettings(models.TransientModel, ResConfigModuleInstallationMixin):
    ...
    def get_config_warning(self, msg):
        ...
        Example of use:
        ---------------
        from izi.addons.base.res.res_config import get_warning_config
