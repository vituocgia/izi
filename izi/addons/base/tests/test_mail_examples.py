...
cite="mid:CAEJSRZvWvud8c6Qp=wfNG6O1+wK3i_jb33qVrF7XyrgPNjnyUA@mail.gmail.com"
      type="cite"><base href="https://www.izi.asia">
      <div dir="ltr">Yep Dominique that is true, as Postgres was the
        base of all same as izi and MySQL etc came much later.Â 
        <div><br>
        </div>
    ...
    on this izi mailinglist, but when you start implying that Postgres
...
<div style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'; COLOR: #000000">
    <div>Hello</div>
    <div>I have just installed izi 9 and I've got the following error:</div>
    <div>&nbsp;</div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content openerp">
                <div class="modal-header"> 
                    <h4 class="modal-title">izi Error<span class="o_subtitle text-muted"></span></h4>
                </div>
