...
from izi import api, fields, models, SUPERUSER_ID, tools,  _
from izi.exceptions import AccessError, UserError, ValidationError
...
class IrModel(models.Model):
    ...
    def unlink(self):
        ...
        # reload is done independently in izi.modules.loading.
        if not self._context.get(MODULE_UNINSTALL_FLAG):
...
class IrModelConstraint(models.Model):
    """
    This model tracks PostgreSQL foreign keys and constraints used by izi
    models.
    """
...
class IrModelRelation(models.Model):
    """
    This model tracks PostgreSQL tables used to implement izi many2many
    relations.
    """
...
class IrModelData(models.Model):
    """Holds external identifier keys for records in the database.
       This has two main uses:
           ...
           * allows tracking the origin of data installed by izi
