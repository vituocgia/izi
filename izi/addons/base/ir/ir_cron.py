...
BASE_VERSION = izi.modules.load_information_from_description_file('base')['version']
...
class ir_cron(models.Model):
    ...
    def _callback(self, cron_name, server_action_id, job_id):
        ...
        try:
            ...
            izi.netsvc.log(_logger, logging.DEBUG, 'cron.object.execute', (self._cr.dbname, self._uid, '*', cron_name, server_action_id), depth=log_depth)
            start_time = False
