...
from izi.tools import pycompat, freehash
    ...
    def _base_module(self):
        ...
        * string_types (replacement for basestring)
        ...
        return ast.parse(dedent("""
            ...
            from izi.tools.pycompat import to_text, string_types
            from izi.addons.base.ir.ir_qweb.qweb import escape, foreach_iterator
            """))
