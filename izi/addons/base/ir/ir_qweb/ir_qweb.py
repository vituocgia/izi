...
from izi import api, models, tools
from izi.tools.safe_eval import assert_valid_codeobj, _BUILTINS, _SAFE_OPCODES
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _get_asset_content(self, xmlid, options):
        ...
        def get_modules_order():
            if request:
                from izi.addons.web.controllers.main import module_boot
