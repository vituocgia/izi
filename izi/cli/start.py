...
from izi.modules.module import get_module_root, MANIFEST_NAMES
from izi.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """Quick start the izi server for your project"""
