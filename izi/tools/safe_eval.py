...
def safe_eval(expr, globals_dict=None, locals_dict=None, mode="eval", nocopy=False, locals_builtins=False):
    ...
    except izi.exceptions.except_orm:
        raise
    except izi.exceptions.Warning:
        raise
    except izi.exceptions.RedirectWarning:
        raise
    except izi.exceptions.AccessDenied:
        raise
    except izi.exceptions.AccessError:
        raise
    except werkzeug.exceptions.HTTPException:
        raise
    except izi.http.AuthenticationError:
        raise
