...
class TestTermCount(common.TransactionCase):
    ...
    def test_count_term(self):
        ...
        """
        izi.tools.trans_load(self.cr, 'test_translation_import/i18n/fr.po', 'fr_FR', verbose=False)
    ...
    def test_noupdate(self):
        ...
        izi.tools.trans_load(self.cr, 'test_translation_import/i18n/fr.po', 'fr_FR', verbose=False, context={'overwrite': True})
