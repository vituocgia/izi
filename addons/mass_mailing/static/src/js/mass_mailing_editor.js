izi.define('mass_mailing.editor', function (require) {
"use strict";
...
snippets_editor.Class.include({
    _computeSnippetTemplates: function (html) {
        ...
        $mail_themes_upgrade.on("click", "> a", function (e) {
            ...
            e.preventDefault();
            izi_top[window.callback+"_do_action"]("mass_mailing.action_mass_mailing_configuration");
        });
        ...
        $dropdown.on("click", "li > a", function (e) {
            ...
            // Notify form view
            izi_top[window.callback+"_downup"]($editable_area.addClass("o_dirty").html());
        });
...
izi_top[callback+"_updown"] = function (value, fields_values, field_name) {
    if (!window || window.closed) {
        delete izi_top[callback+"_updown"];
        return;
    }
