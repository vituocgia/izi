izi.define('pad.pad_tests', function (require) {
"use strict";
...
QUnit.module('pad widget', {
        ...
        this.data = {
            task: {
                ...
                records: [
                    ...
                    {id: 2, description: "https://pad.izi.pad/p/test-03AK6RCJT"},
                ],
                ...
                pad_generate_url: function (route, args) {
                    return {
                        url:'https://pad.izi.pad/p/test/' + args.context.object_id
                    };
                },
    ...
    QUnit.test('pad widget works, basic case', function (assert) {
        ...
        var form = createView({
            ...
            res_id: 1,
            mockRPC: function (route, args) {
                if (route === 'https://pad.izi.pad/p/test/1?showChat=false&userName=batman') {
