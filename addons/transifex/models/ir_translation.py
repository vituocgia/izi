...
from izi.modules.module import ad_paths
...
class IrTranslation(models.Model):
    ...
    def _get_transifex_url(self):
        ...
        # e.g. 'https://www.transifex.com/izi/'
        ...
        for addon_path in ad_paths:
            ...
            if os.path.isfile(tx_path):
                ...
                # first section is [main], after [izi-11.sale]
                tx_sections.extend(tx_config_file.sections()[1:])

            # parent directory ad .tx/config is root directory in izi/izi
        ...
        if not base_url or not tx_sections:
            ...
            # using ini files like '[izi-master.website_sale]'
            ...
            for translation in self:
                ...
                # e.g. https://www.transifex.com/izi/izi-10/translate/#fr/sale/42?q=text'Sale+Order'
