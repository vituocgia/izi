define([
  ...
  var range = (function () {
    ...
    var WrappedRange = function (sc, so, ec, eo) {
       ...
       * @return {WrappedRange}
       */
      if(_.isUndefined(this.deleteContents)) // izi: ability to override by prototype
      ...
      this.wrapBodyInlineWithPara = function () {
        ...
        // izi: insert a p tag when try to insert a br with insertNode method, if the editor is inside a p, li, h1... (start_modification
      ...
      this.insertNode = function (node) {
        ...
        // izi: override to not split world for inserting inline
   ...
   */
    return {
      WrappedRange: WrappedRange, // izi: give access to WrappedRange
      /**
       * @method
       * 
