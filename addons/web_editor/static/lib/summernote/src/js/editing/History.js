define(['summernote/core/range', 'summernote/core/dom'], function (range, dom) { // izi: suggest upstream
  /**
  ...
  var History = function ($editable) {
    ...
    var makeSnapshot = function () {
      ...
      return {
        ...
        // izi: suggest upstream added " && dom.ancestor(rng.sc, dom.isEditable) "
      };
    };
    ...
    var last; // izi: to suggest upstream (since we may have several editor)
    /**
     * recorded undo
     */
    this.recordUndo = function () {
      // izi: method totally rewritten
