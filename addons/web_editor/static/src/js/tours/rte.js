izi.define('web_editor.tour', function (require) {
'use strict';
...
tour.register('rte', {
    ...
    run: function () {
        var html = '\n'+
            ...
            '        </div>\n'+
            '        <div class="col-md-6 mt16">\n'+
            '            <img class="img img-responsive shadow mb16" src="/web/static/src/img/logo.png" alt="izi text and image block">\n'+
            '        </div>\n'+
            '    </div>\n'+
            '</section>\n';
...
tour.register('rte_inline', {
    ...
    run: function () {
        var html = '\n'+
            ...
            '        </td>\n'+
            '        <td valign="center" width="270">\n'+
            '          <a href="https://www.facebook.com/izi"><span class="fa fa-facebook-square fa-2x text-primary"></span></a>\n'+
