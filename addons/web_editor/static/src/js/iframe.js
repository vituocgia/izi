izi.define('web_editor.iframe', function (require) {
'use strict';
...
window.top.izi[callback + '_updown'] = function (value, fields_values, field_name) {
...
editor.Class.include({
    start: function () {
        this.on('rte:start', this, function () {
            ...
            if (window.top.izi[callback + '_editor']) {
                window.top.izi[callback + '_editor'](this);
            }
            ...
            $editable.on('content_changed', this, function () {
                if (window.top.izi[callback + '_downup']) {
                    window.top.izi[callback + '_downup']($editable.prop('innerHTML'));
                }
            });
        });
...
izi.define('web_editor.IframeRoot.instance', function (require) {
'use strict';
...
izi.define('web_editor.IframeRoot', function (require) {
'use strict';
