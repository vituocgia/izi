izi.define('web_editor.web_editor_tests', function (require) {
"use strict";
    ...
    var form = testUtils.createView({
        ...
        mockRPC: function (route, args) {
            ...
            if (_.str.startsWith(route, '/logo')) {
                ...
                window.izi[$.deparam(route).callback + '_content'].call();
                return $.when();
            }
            return this._super.apply(this, arguments);
        },
    ...
    var form = testUtils.createView({
        ...
        mockRPC: function (route, args) {
            ...
            if (_.str.startsWith(route, '/logo')) {
                ...
                window.izi[$.deparam(route).callback + '_content']();
                return $.when();
            }
            return this._super.apply(this, arguments);
        },
        ...
        mockRPC: function (route, args) {
            ...
            if (_.str.startsWith(route, '/logo')) {
                ...
                return loadDeferred.then(function () {
                    var contentCallback = window.izi[callback + '_content'];
                    var editorCallback = window.izi[callback + '_editor'];
