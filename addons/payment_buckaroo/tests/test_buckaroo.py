...
from izi.addons.payment_buckaroo.controllers.main import BuckarooController
from izi.tools import mute_logger


@izi.tests.common.at_install(False)
@izi.tests.common.post_install(False)
...
class BuckarooForm(BuckarooCommon):
    ...
    @mute_logger('izi.addons.payment_buckaroo.models.payment', 'ValidationError')
    def test_20_buckaroo_form_management(self):
        ...
        buckaroo_post_data = {
            ...
            'BRQ_SERVICE_PAYPAL_PAYEREMAIL': u'fhe@izi.asia',
