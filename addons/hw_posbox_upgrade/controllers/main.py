...
<html>
    <head>
        <title>izi's PosBox - Software Upgrade</title>
	...
	<p></p>
        ...
        the <a href='http://nightly.izi.asia/trunk/posbox/'>latest image</a>. The upgrade
        procedure is explained into to the
        <a href='https://www.izi.asia/documentation/user/point_of_sale/posbox/index.html'>PosBox manual</a>
        </p>
        <p>
        ...
        <pre>
"""
upgrade_template += subprocess.check_output("git --work-tree=/home/pi/izi/ --git-dir=/home/pi/izi/.git log -1", shell=True).replace("\n", "<br/>")
upgrade_template += """
        </pre>
        <div class='centering'>
...
class PosboxUpgrader(hw_proxy.Proxy):
    ...
    def perform_upgrade(self):
        ...
        os.system('/home/pi/izi/addons/point_of_sale/tools/posbox/configuration/posbox_update.sh')
