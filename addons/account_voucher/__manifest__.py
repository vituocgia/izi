...
=====================================================
The specific and easy-to-use Invoicing system in izi allows you to keep track of your accounting, even when you are not an accountant. It provides an easy way to follow up on your vendors and customers. 
...
* Voucher Payment [Customer & Vendors]
    ...
    'category': 'Accounting',
    'sequence': 20,
    'website' : 'https://www.izi.asia/page/billing',
    'depends' : ['account'],
    'demo' : [],
    'data' : [
