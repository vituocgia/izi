...
from izi import api, http, SUPERUSER_ID, _
from izi.exceptions import AccessDenied
from izi.http import request
from izi import registry as registry_get

from izi.addons.auth_signup.controllers.main import AuthSignupHome as Home
from izi.addons.web.controllers.main import db_monodb, ensure_db, set_cookie_and_redirect, login_and_redirect
...
class OAuthController(http.Controller):
    ...
    def oea(self, **kw):
        """login user via izi Account provider"""
