function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('izi-google-map'), {
        zoom: 1,
    ...
    if (izi_partner_data){ /* izi_partner_data special variable should have been defined in google_map.xml */
        for (var i = 0; i < izi_partner_data.counter; i++) {
            set_marker(izi_partner_data.partners[i]);
        }
