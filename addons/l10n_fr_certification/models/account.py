...
from izi import models, api, fields
...
class AccountMove(models.Model):
    ...
    def _check_hash_integrity(self, company_id):
        ...
        raise UserError(_('''Successful test !
                         ...
                         For this report to be legally meaningful, please download your certification from your customer account on izi.asia (Only for izi Enterprise users).'''
                         ) % report_dict)
