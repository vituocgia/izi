...
from izi.addons.web.controllers import main as web
...
class HardwareScreen(web.Home):
    ...
    def _get_html(self):
        ...
        html = """
            ...
            <html>
                <head>
                <title class="origin">izi -- Point of Sale</title>
                ...
                <body class="original_body">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-md-offset-4">
                            ...
                            <p>izi version 11 or above is required.</p>
                        </div>
                    </div>
                    </div>
                </body>
