...
from izi.release import version
from izi.tools import DEFAULT_SERVER_DATE_FORMAT as DF
...
class CrmTeam(models.Model):
    ...
    reply_to = fields.Char(string='Reply-To',
                           help="The email address put in the 'Reply-To' of all emails sent by izi about cases in this sales channel")
