...
from izi.tests.common import TransactionCase, can_import
from izi.modules.module import get_module_resource
from izi.tools import mute_logger, pycompat
...
class TestPreview(TransactionCase):
    ...
    @mute_logger('izi.addons.base_import.models.base_import')
