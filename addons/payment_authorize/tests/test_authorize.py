...
@izi.tests.common.at_install(True)
...
class AuthorizeForm(AuthorizeCommon):
    ...
    @mute_logger('izi.addons.payment_authorize.models.payment', 'ValidationError')
    ...
    def test_30_authorize_s2s(self):
        ...
        # add credential
        # FIXME: put this test in master-nightly on izi/izi + create sandbox account
        authorize.write({
