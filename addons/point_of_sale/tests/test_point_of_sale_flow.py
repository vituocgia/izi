...
from izi.tools import float_compare, mute_logger, test_reports
from izi.addons.point_of_sale.tests.common import TestPointOfSaleCommon
...
class TestPointOfSaleFlow(TestPointOfSaleCommon):
    ...
    def test_create_from_ui(self):
        ...
        with mute_logger('izi.addons.point_of_sale.models.pos_order'):
