...
class TestUi(izi.tests.HttpCase):
    def test_01_pos_basic_order(self):
        ...
        self.phantom_js("/pos/web",
                        "izi.__DEBUG__.services['web_tour.tour'].run('pos_pricelist')",
                        "izi.__DEBUG__.services['web_tour.tour'].tours.pos_pricelist.ready",
                        login="admin")

        self.phantom_js("/pos/web",
                        "izi.__DEBUG__.services['web_tour.tour'].run('pos_basic_order')",
                        "izi.__DEBUG__.services['web_tour.tour'].tours.pos_basic_order.ready",
                        login="admin")
