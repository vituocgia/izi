...
from izi import _, api, exceptions, fields, models, tools
...
class MailThread(models.AbstractModel):
    ...
    def message_get_email_values(self, notif_mail=None):
        ...
        return {'headers': repr({
            'X-izi-Objects': "%s-%s" % (self._name, self.id),
            'X-izi-db-uuid': database_uuid
        })}
   ...
   Only allowed people can contact us at this address.</p>
    ...
    def message_route(self, message, message_dict, model=None, thread_id=None, custom_values=None):
         ...
         * if the message replies to an existing thread by having In-Reply-To or
           References matching izi model/thread_id Message-Id and if this thread
