...
from izi import api, release, SUPERUSER_ID
from izi.exceptions import UserError
from izi.models import AbstractModel
from izi.tools.translate import _
from izi.tools import config, misc, ustr
...
class PublisherWarrantyContract(AbstractModel):
    ...
    def update_notification(self, cron_mode=True):
        """
        Send a message to izi's publisher warranty server to check the
