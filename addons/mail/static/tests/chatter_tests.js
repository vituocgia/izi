izi.define('mail.chatter_tests', function (require) {
"use strict";
...
QUnit.test('chatter: post, receive and star messages', function (assert) {
    ...
    var form = createView({
        ...
        mockRPC: function (route, args) {
            ...
            if (args.method === 'get_mention_suggestions') {
                ...
                return $.when([{email: "test@izi.asia", id: 1, name: "Test User"}]);
            }
            return this._super(route, args);
        },
        session: {},
    ...
    getSuggestionsDef
        ...
        .then(function () {
            ...
            assert.strictEqual(form.$('.o_mention_proposition .o_mention_info').text(), '(test@izi.asia)',
                "suggestion should be displayed correctly");
