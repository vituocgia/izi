izi.define('account.dashboard_setup_bar', function (require) {
"use strict";
...
var AccountSetupBarController = KanbanController.extend({
    ...
    **/
    _triggerCompanyButtonAction: function (iziEvent) {
        var self = this
        if (iziEvent.data.rpc_method !== undefined) {
            self._rpc({
                    model: 'res.company',
                    method: iziEvent.data.rpc_method,
                    args: [],
                })
                .then(
                    function(rslt_action) {
                        if (rslt_action !== undefined) {
                            self.do_action(rslt_action, {
                                action_context: iziEvent.data.context,
                                on_close: function () {
