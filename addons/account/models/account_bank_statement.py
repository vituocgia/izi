...
from izi.tools import float_is_zero, pycompat
from izi.tools import float_compare, float_round, float_repr
...
class AccountBankStatementLine(models.Model):
    ...
    def _check_amount(self):
        ...
        # so that user can enter/import the exact bank statement they have received from their bank in izi
