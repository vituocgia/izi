...
class TestUi(izi.tests.HttpCase):
    ...
    def test_admin(self):
        ...
        self.phantom_js("/", "izi.__DEBUG__.services['web_tour.tour'].run('event_buy_tickets')", "izi.__DEBUG__.services['web_tour.tour'].tours.event_buy_tickets.ready", login="admin")

    def test_demo(self):
        self.phantom_js("/", "izi.__DEBUG__.services['web_tour.tour'].run('event_buy_tickets')", "izi.__DEBUG__.services['web_tour.tour'].tours.event_buy_tickets.ready", login="demo")
