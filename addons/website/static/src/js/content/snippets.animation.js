izi.define('website.content.snippets.animation', function (require) {
'use strict';
...
registry.mediaVideo = Animation.extend({
    ...
    start: function () {
        ...
        // integrated with izi (this refactoring should be done in master).
 ...
 *
 * This should be removed in a future izi snippets refactoring.
 */
