izi.define('web.test_utils', function (require) {
"use strict";
 ...
 * not fire.
 *
 * @param {Widget} widget the target widget (any izi widget)
 ...
 *   the DOM. Also, the logLevel will be forced to 2 and the uncaught iziEvent
 *   will be logged
...
function createAsyncView(params) {
    ...
    // make sure all izi events bubbling up are intercepted
 ...
 *   used to generate mock answers for every kind of routes supported by izi
