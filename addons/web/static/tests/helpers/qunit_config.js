 ...
 * QUnit Config
 *
 * The izi javascript test framework is based on QUnit (http://qunitjs.com/).
 * This file is necessary to setup Qunit and to prepare its interactions with
 * izi.  It has to be loaded before any tests are defined.
 *
 * Note that it is not an izi module, because we want this code to be executed
 * as soon as possible, not whenever the izi module system feels like it.
 */
 ...
 * this is done outside of izi modules, otherwise the setting would not take
 * effect on time.
 */
