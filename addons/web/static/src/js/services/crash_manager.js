izi.define('web.CrashManager', function (require) {
"use strict";
...
var CrashManager = core.Class.extend({
    ...
    rpc_error: function(error) {
        ...
        if (error.data.name === "izi.http.SessionExpiredException" || error.data.name === "werkzeug.exceptions.Forbidden") {
            this.show_warning({type: _t("izi Session Expired"), data: {message: _t("Your izi session expired. Please refresh the current web page.")}});
            return;
        }
    ...
    show_warning: function(error) {
        ...
        return new Dialog(this, {
            size: 'medium',
            title: _.str.capitalize(error.type || error.message) || _t("izi Warning"),
    ...
    show_error: function(error) {
        ...
        var dialog = new Dialog(this, {
            title: _.str.capitalize(error.type || error.message) || _t("izi Error"),
...
var RedirectWarningHandler = Dialog.extend(ExceptionHandler, {
    ...
    display: function() {
        ...
        new Dialog(this, {
            size: 'medium',
            title: _.str.capitalize(error.type) || _t("izi Warning"),
            buttons: [
...
core.crash_registry.add('izi.exceptions.RedirectWarning', RedirectWarningHandler);

return CrashManager;
});

izi.define('web.crash_manager', function (require) {
"use strict";
