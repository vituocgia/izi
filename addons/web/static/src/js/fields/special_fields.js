izi.define('web.special_fields', function (require) {
"use strict";
...
var FieldTimezoneMismatch = FieldSelection.extend({
    ...
    _renderTimezoneMismatch: function () {
        ...
        if (this.mismatch){
            ...
            $span.attr('title', _t("Timezone Mismatch : The timezone of your browser doesn't match the selected one. The time in izi is displayed according to your field timezone."));
