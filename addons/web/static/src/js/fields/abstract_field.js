izi.define('web.AbstractField', function (require) {
"use strict";
...
var AbstractField = Widget.extend({
    ...
    */
     ...
     *
     * @param {any} record
     * @param {iziEvent} [event] an event that triggered the reset action. It
     ...
     * @private
     * @param {any} record
     * @param {iziEvent} event the event that triggered the change
     */
