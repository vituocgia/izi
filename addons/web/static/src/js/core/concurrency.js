izi.define('web.concurrency', function (require) {
"use strict";
 ...
 * everything concurrency related in izi.
 *
 * The basic concurrency primitives in izi JS are the callback, and the
...
return {
    ...
    /**
     * A (izi) mutex is a primitive for serializing computations.  This is
