izi.define('web.dom_ready', function (require) {
'use strict';
...
izi.define('web.dom', function (require) {
"use strict";
 ...
 * functionalities with the izi framework.  A common theme in these functions
...
return {
    ...
    /**
     * Renders a button with standard izi template. This does not use any xml
    ...
    /**
     * Renders a checkbox with standard izi template. This does not use any xml
     * template to avoid forcing the frontend part to lazy load a xml file for
