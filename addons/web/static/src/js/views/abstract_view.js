izi.define('web.AbstractView', function (require) {
"use strict";

/**
 * This is the base class inherited by all (JS) views. izi JS views are the
 ...
 * the word 'view' has historical significance in izi code, so we replaced the
