izi.define('survey.tour_test_survey', function (require) {
'use strict';
...
tour.register('test_survey', {
    ...
    [
        ...
        // Page-2
        // Question: What do you think about the documentation available on doc.izi.asia?
        {
        ...
        {
            content: "For 'I use the contextual help in izi' checking 'Agree'",
        ...
        // Question: What do you think about the process views of izi, available in the web client ?
        {
            content: "For 'They help new users to understand izi' checking 'Totally disagree'",
        ...
        // Page-3
        // Question: How do you contribute or plan to contribute to izi?
        {
