...
class PaypalForm(PaypalCommon):
    ...
    def test_10_paypal_form_render(self):
        ...
        self.paypal.write({'paypal_email_account': 'tde+paypal-facilitator@izi.asia', 'fees_active': False})
        ...
        form_values = {
            'cmd': '_xclick',
            'business': 'tde+paypal-facilitator@izi.asia',
    ...
    @mute_logger('izi.addons.payment_paypal.models.payment', 'ValidationError')
    def test_20_paypal_form_management(self):
        ...
        paypal_post_data = {
            ...
            'mc_currency': u'EUR',
            'shipping': u'0.00',
            'payer_email': u'tde+buyer@izi.asia',
