...
from izi.addons.calendar.models.calendar import calendar_id2real_id
...
class TestRecurrentEvent(common.TransactionCase):
    ...
    def test_recurrent_meeting1(self):
        # In order to test recurrent meetings in izi, I create meetings with different recurrence using different test cases.
